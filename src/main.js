...
const createTaskActionsTemplate = () => {
  return (
...
const createTasksCategoriesTemplate = () => {
...
const createContentBoardElementTemplate = () => {
  return (`<section class="board container">
</section>`)
};

const createTasksFilterTemplate = () => {
...
const createListOfBoardTasksTemplate = () => {
  return (`<div class="board__tasks">
</div>`)
};

const createBlackCardTaskTemplate = () => {
...
const createCardEditorTemplate = () => {
